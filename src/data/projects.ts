...
export const web3Projects: Project[] = [
  {
    ...
    technologies: ['Base', 'Solidity', 'React', 'WhatsApp API', 'Node.js', 'Web3.js', 'Smart Contracts', 'Foundry', 'Golang'],
    demoLink: 'https://terafinance.vercel.app/',
    codeLink: 'https://github.com/orgs/Tera-finance/repositories',
    category: 'blockchain',
  },
  {
    id: 'sonnetix',
    ...
    technologies: ['Base', 'Solidity', 'React', 'IPFS', 'Web3.js', 'Node.js', 'NFT Standards', 'Smart Contracts'],
    demoLink: 'https://sonnetix.izcy.tech/',
  ...
  },
  {
    ...
    technologies: ['Base', 'Solidity', 'React', 'Golang', 'IPFS', 'Web3.js', 'The Graph', 'NFT Standards', 'Smart Contracts'],
    demoLink: 'https://tunecent.vercel.app/',
    codeLink: 'https://github.com/orgs/TuneCent/repositories',
    category: 'blockchain',
  },
  {
    id: 'lalochain',
    ...
    demoLink: 'https://web-la-lo-chain.vercel.app/',
    codeLink: 'https://github.com/orgs/ChaiNova-id/repositories',
    category: 'blockchain',
  },
  {
    id: 'mallvest',
    ...
    demoLink: 'https://mallvest.vercel.app/',
    codeLink: 'https://github.com/fabian4819/MallVest-Web',
    category: 'blockchain',
  },
  {
    id: 'trustbridge',
    ...
    demoLink: 'https://trustbridge.izcy.tech/',
    codeLink: 'https://github.com/orgs/UGM-Cardano/repositories',
    category: 'blockchain',
  }
];
...
export const web2Projects: Project[] = [
  {
    ...
    technologies: ['React', 'Node.js', 'Golang', 'MongoDB', 'TensorFlow.js', 'Socket.io', 'Chart.js'],
    demoLink: 'https://waras-in.vercel.app/',
    codeLink: 'https://github.com/anggito-m/WarasIn',
    category: 'web2',
  },
  {
    ...
    demoLink: 'https://ohoi-ngadi.id',
    codeLink: 'https://github.com/fabian4819/ngadi-tourism-village',
    category: 'web2',
  },
  {
    ...
    technologies: ['Flutter', 'Dart', 'Firebase', 'Google Maps API', 'AsyncStorage'],
    demoLink: '',
    codeLink: 'https://github.com/fabian4819/DTETI-X-BOROBUDUR-APPS',
    category: 'mobile',
  },
  {
    id: 'gastreit',
    ...
    demoLink: '',
    codeLink: 'https://github.com/fabian4819/PKM-GASTREIT',
    category: 'mobile',
  },
  {
    id: 'perdana-property',
    ...
    demoLink: 'https://perdana-property.vercel.app/',
  ...
  },
  {
    ...
    demoLink: 'https://fe.roetix.com/',
    codeLink: 'https://github.com/fabian4819/roetix-frontend',
    category: 'saas',
  },
  {
    id: 'novatix',
